...
void SensorsCallback(void const * argument);
...
void MX_FREERTOS_Init(void) {
  ...
  osTimerDef(Sensors, SensorsCallback);
  SensorsHandle = osTimerCreate(osTimer(Sensors), osTimerPeriodic, NULL);
